...
echo.
echo   3. GLM (Z.ai) (z.ai - Anthropic-compatible, GLM Coding Plan^)
echo      Cheap coding-focused plan, GLM-5.2 / GLM-5-Turbo models
echo.

set "LLM_PROVIDER="
set /p "LLM_PROVIDER=  Choose [1] DeepSeek, [2] OpenCode Go, or [3] GLM: "
if "!LLM_PROVIDER!"=="" set "LLM_PROVIDER=1"
if not "!LLM_PROVIDER!"=="1" if not "!LLM_PROVIDER!"=="2" if not "!LLM_PROVIDER!"=="3" (
...
echo # Generated by setup.bat on %date% %time%
echo.
echo # GLM / Z.ai API Key (https://z.ai^)
